...
<div class="custom-tab-1">
  ...
  <div class="copyright">
    <p><strong>Retechgen Hospital Admin Dashboard</strong> © 2021 All Rights Reserved</p>
    <p>Made with <span class="heart"></span> byRetechgen</p>
  </div>
</div>
  </div>
...
<div class="container-fluid">
  <div class="form-head d-flex mb-3 mb-md-5 align-items-start">
    <div class="mr-auto d-none d-lg-block">
      <h3 class="text-primary font-w600">Welcome to Retechgen!</h3>
              ...
              <div class="table-responsive ">
                <table class="table patient-activity">
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="mr-3 img-fluid rounded" width="78" src="images/avatar/1.jpg" alt="Retechgen">
                        <div class="media-body">
                  ...
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="mr-3 img-fluid rounded" width="78" src="images/avatar/2.jpg" alt="Retechgen">
                        <div class="media-body">
                  ...
                  <tr class="active">
                    <td>
                      <div class="media align-items-center">
                        <img class="mr-3 img-fluid rounded" width="78" src="images/avatar/3.jpg" alt="Retechgen">
                        <div class="media-body">
                  ...
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="mr-3 img-fluid rounded" width="78" src="images/avatar/4.jpg" alt="Retechgen">
                        <div class="media-body">
                  ...
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="mr-3 img-fluid rounded" width="78" src="images/avatar/5.jpg" alt="Retechgen">
                        <div class="media-body">
                  ...
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="mr-3 img-fluid rounded" width="78" src="images/avatar/6.jpg" alt="Retechgen">
                        <div class="media-body">
  ...
  <div class="footer">
      <div class="copyright">
          <p>Copyright © Designed &amp; Developed by <a href="http://Retechgen.com/" target="_blank">Retechgen</a> 2021</p>
      </div>
  </div>
